...
echo "Running: kubectl create -f ${KUBECONFIG_FOLDER}/chaincode_install_node.yaml"
...
while [ "${JOBSTATUS}" != "1/1" ]; do
    echo "Waiting for chaincodeinstallnode job to be completed"
    sleep 1;
...
echo "Running: kubectl create -f ${KUBECONFIG_FOLDER}/chaincode_instantiate_node.yaml"
...
while [ "${JOBSTATUS}" != "1/1" ]; do
    echo "Waiting for chaincodeinstantiatenode job to be completed"
    sleep 1;
